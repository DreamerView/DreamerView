...
const translations = {
  en: {
    ...
    bio1: "I'm Temirkhan, a developer focused on building fast, lightweight, and user-friendly web tools.",
  ...
  ru: {
    ...
    location: "🌍 Казахстан 🇰🇿",
    bio1: "Я Темирхан, разработчик, создающий быстрые, лёгкие и удобные веб-инструменты.",
  ...
  kk: {
    ...
    location: "🌍 Қазақстан 🇰🇿",
    bio1: "Мен Темірханмын — жылдам, жеңіл және ыңғайлы веб-құралдарды жасайтын әзірлеушімін.",
